...
urlpatterns = [
    ...
    path("staffs/<int:pk>/", StaffStatusUpdateAPIView.as_view(), name="staff-status-update-s"),
    path("managers/<int:pk>/", ManagerStatusUpdateAPIView.as_view(), name="staff-status-update-m"),
]
